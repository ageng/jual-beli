...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        {{ HTML::style('http://cdnjs.cloudflare.com/ajax/libs/normalize/3.0.1/normalize.css') }}
            ...
            <header>
                ...
                <section id="action-bar">
                    ...
                    <nav class="dropdown">
                        <ul>
                            <li>
                                <a href="#">Shop by Category {{ HTML::image('img/down-arrow.gif', 'Shop Category') }}</a>
                                <ul>
                    ...
                    <div id="view-cart">
                        <a href="#">{{ HTML::image('img/blue-cart.gif', 'View Chart')}} View Cart</a>
                    </div><!-- end view-cart -->
